...
const About = () => {
    return (
        <section id="about">
            ...
            <img src="https://clairecashmore17.github.io/Portfolio/images/claire-profile.jpg" alt="Claire Cashmore" />
            ...
            <p id="about-me">
                ...
                I plan to attend George Washington University to attain my masters in Computer Science specializing in Computer Graphics, animation, and multimedia. I have a large interest in the gaming and/or graphic development specifically.<br /><br />
